...
urlpatterns = [
    ...
    path('/reset-password/done', PasswordResetDoneView.as_view(template_name=f'{app_name}/password/reset_done.jinja2'),
         name='password_reset_done'),
    path('/reset-password/confirm/<str:uidb64>/<str:token>', views.PasswordResetConfirmView.as_view(),
         name='password_reset_confirm'),
    path('/reset-password/complete',
         PasswordResetCompleteView.as_view(template_name=f'{app_name}/password/reset_complete.jinja2'),
