...
class AZone(BaseSqlModel):
    ...
    kind: Mapped[AZoneKindEnum] = mapped_column(String, nullable=False)
    ...
    masters: Mapped[list[str]] = mapped_column(String, nullable=True)
    ...
    nsec3param: Mapped[str] = mapped_column(String, nullable=True)
    ...
    soa_edit: Mapped[str] = mapped_column(String, nullable=True)
    """The SOA-EDIT metadata item."""

    soa_edit_api: Mapped[str] = mapped_column(String, nullable=True)
    ...
    master_tsig_key_ids: Mapped[list[str]] = mapped_column(String, nullable=True)
    """The id of the TSIG keys used for master operation in this zone."""

    slave_tsig_key_ids: Mapped[list[str]] = mapped_column(String, nullable=True)
    ...
    metadata = relationship('AZoneMetadata', back_populates='zone')
...
class AZoneRecord(BaseSqlModel):
    ...
    type_: Mapped[ZoneRecordTypeEnum] = mapped_column(String, nullable=False)
...
class AZoneMetadata(BaseSqlModel):
    ...
    values: Mapped[list[str]] = mapped_column(String, nullable=True)
    ...
    zone = relationship('AZone', back_populates='metadata')
...
class RZone(BaseSqlModel):
    ...
    kind: Mapped[RZoneKindEnum] = mapped_column(String, nullable=False)
    """The kind of the zone."""
