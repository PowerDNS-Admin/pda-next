...
from app.lib.mysql import MysqlClient, MysqlDbConfig
from app.models.db.tasks import TaskJob
...
class DynamicScheduler(Scheduler):
    ...
    def build_beat_schedule(self) -> dict:
        ...
        from loguru import logger
        from app.lib import load_config, load_schedules
        from app.lib.util.dt import TimeUtil
...
class SignalHandler:
    ...
    def get_task_job(self, task_id: str, request: Union[Request, Context] = None) -> TaskJob:
        ...
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def save_task_job(self, task_job: TaskJob, create_activity: bool = True):
        ...
        from sqlalchemy.orm import Session
        from sqlalchemy.orm.exc import UnmappedInstanceError
        from app.models.db.tasks import TaskJobStatusEnum, TaskJobActivity
    ...
    def task_received_handler(self, request: Request, **kwargs):
        ...
        from app.lib.notifications.events import TaskReceivedEvent
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_revoked_handler(self, request: Context, terminated: bool, signum: int, expired: bool, **kwargs):
        ...
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskRevokedEvent
        from app.lib.services.zabbix import ZabbixMetric
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_rejected_handler(self, message: str, exc: Exception, **kwargs):
        ...
        from app import initialize, notifications
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskRejectedEvent
    ...
    def task_pre_run_handler(self, task_id: str, task: Task, **kwargs):
        ...
        from app import initialize, notifications, zabbix
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskPreRunEvent
        from app.lib.services.zabbix import ZabbixMetric
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_post_run_handler(self, task_id: str, task: Task, **kwargs):
        ...
        from app import initialize, notifications
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskPostRunEvent
    ...
    def task_retry_handler(self, request: Context, reason: str, einfo: ExceptionInfo, **kwargs):
        ...
        from app import initialize, notifications, zabbix
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskRetryEvent
        from app.lib.services.zabbix import ZabbixMetric
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_internal_error_handler(self, task_id: str, args, kwargs, request: Request, exception, traceback, einfo: ExceptionInfo, **kw):
        ...
        from app import initialize, notifications, zabbix
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskInternalErrorEvent
        from app.lib.services.zabbix import ZabbixMetric
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_success_handler(self, sender, result: Any, **kwargs):
        ...
        from app import initialize, notifications, zabbix
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskSuccessEvent
        from app.lib.services.zabbix import ZabbixMetric
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_failure_handler(self, sender, task_id: str, exception: Exception, args, kwargs, traceback, einfo: ExceptionInfo, **kw):
        ...
        from app import initialize, notifications, zabbix
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskFailedEvent
        from app.lib.services.zabbix import ZabbixMetric
        from app.models.db.tasks import TaskJobStatusEnum
    ...
    def task_unknown_handler(self, name: str, id: str, message: Message, exc: Exception, **kw):
        ...
        from app.lib.notifications import NotificationManager
        from app.lib.notifications.events import TaskUnknownEvent
